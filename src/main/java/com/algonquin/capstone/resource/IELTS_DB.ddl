...
INSERT INTO questions VALUES ('a41c1a5e-559d-4c48-b1b2-7759829dc38f', 'What is the chemical formula for water?', 'CO2', 'H2O' , 'NaCl', 'NH3', '2', 'Chemistry', '2022-07-12', '2');
...
INSERT INTO questions VALUES ('1fbfebb6-31aa-43d3-b60b-6e3d3a39e6a9', 'What is the largest country in the world?', 'China', 'India', 'United States', 'Russia', '4', 'Geography', '2022-05-27', '1');
INSERT INTO questions VALUES ('7d019d0a-73fa-41e6-b9b6-2d6cb886c40a', 'What is the formula for the area of a triangle?', 'A = πr²', 'A = lw', 'A = bh', 'A = (1/2)bh', '4', 'Mathematics', '2022-09-03', '2');
...
INSERT INTO questions VALUES ('45cc04e7-7a8f-4bde-b9e6-ee0311d88d3b', 'What is the capital city of Italy?', 'Paris', 'Madrid', 'Rome',  'Berlin', '3', 'Geography', '2022-02-28', '1');
...
INSERT INTO questions VALUES ('9e9a9438-1bfb-4d4e-82f4-4f337deebc4e', 'What is the symbol for the element sodium?', 'Fe', 'Na',  'Au', 'Ag', '2', 'Chemistry', '2022-10-15', '2');
INSERT INTO questions VALUES ('c77d0453-c12c-4f39-9502-464f05a70cb9', 'Who wrote "To Kill a Mockingbird"?', 'F. Scott Fitzgerald', 'Harper Lee', 'Mark Twain', 'Ernest Hemingway', '2', 'Literature', '2022-03-01', '3');
...
INSERT INTO questions VALUES ('b8c9b187-9bdf-4bae-8c31-2bc739d76d92', 'What is the symbol for the element carbon?', 'H', 'O', 'N', 'C',  '4', 'Chemistry', '2023-05-22', '2');
...
INSERT INTO questions VALUES ('7ed5a5a5-5fb5-4ba8-a7f5-98e15d27a947', 'What is the largest organ in the human body?', 'Liver', 'Heart', 'Skin', 'Lungs', '3', 'Biology', '2023-09-10', '2');
INSERT INTO questions VALUES ('b1d8de01-0e49-48b7-9bba-f8b70255757b', 'What is the capital city of Japan?', 'Kyoto', 'Tokyo', 'Osaka', 'Hiroshima', '2', 'Geography', '2023-10-05', '1');
...
INSERT INTO questions VALUES ('5b5dc72d-2d2a-4b2c-a3f1-8f91e96a918d', 'What is the smallest planet in our solar system?', 'Venus', 'Mercury',  'Mars', 'Earth', '2', 'Astronomy', '2024-05-10', '2');
INSERT INTO questions VALUES ('38e874cb-7a2a-4711-a7e1-90570f9d015c', 'Who won the Best Actress Oscar in 2021?', 'Viola Davis', 'Andra Day', 'Carey Mulligan', 'Frances McDormand', '4', 'Movies', '2024-06-20', '3');
INSERT INTO questions VALUES ('ec9ebf58-f6e9-4bb2-a522-2b6d0e76d8dc', 'What is the smallest country in the world?', 'Monaco', 'Nauru', 'Tuvalu', 'Vatican City',  '4', 'Geography', '2024-07-05', '1');
